 ...
 * all news regexes created by XRegExp. This causes an error to be thrown when creating regexes if
 ...
 *
 * @memberOf XRegExp
 * @param {RegExp} regex Regex object that matches the news token.
 * @param {Function} handler Function that returns a news pattern string (using native regex syntax)
...
/**
 * Returns a news string with one or all matches of a pattern replaced. The pattern can be a string
