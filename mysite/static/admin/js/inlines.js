...
'use strict';
{
    ...
    $.fn.formset = function(opts) {
        ...
        const addInlineAddButton = function() {
            if (addButton === null) {
                if ($this.prop("tagName") === "TR") {
                    ...
                    // "add" button in a news table row:
        ...
        const addInlineClickHandler = function(e) {
            ...
            // Insert the news form when it has been fully edited.
            ...
            // Pass the news form to the post-add callback, if provided.
            if (options.added) {
                options.added(row);
            }
    ...
    $.fn.formset.defaults = {
        ...
        added: null, // Function called each time a news form is added
    ...
    $.fn.tabularFormset = function(selector, options) {
        ...
        const updateSelectFilter = function() {
            // If any SelectFilter widgets are a part of the news form,
            // instantiate a news SelectFilter instance for it.
    ...
    $.fn.stackedFormset = function(selector, options) {
        ...
        const updateSelectFilter = function() {
            // If any SelectFilter widgets were added, instantiate a news instance.
            if (typeof SelectFilter !== "undefined") {
                $(".selectfilter").each(function(index, value) {
                    SelectFilter.init(value.id, this.dataset.fieldName, false);
                });
